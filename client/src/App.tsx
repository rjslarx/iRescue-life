...
function RouterSwitch() {
  return (
    <Switch>
      ...
      <ProtectedRoute path="/dashboard/newsletter-designer" pageId="communications" component={NewsletterDesignerPage} />
      ...
      <ProtectedRoute path="/dashboard/compliance" pageId="compliance" component={ComplianceSettingsPage} />
