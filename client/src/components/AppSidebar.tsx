...
export default function AppSidebar({ rescueName, userName, userRole }: AppSidebarProps) {
  ...
  const adminGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Animal Lookup", url: "/dashboard/animal-lookup", icon: Search },
        { title: "Kennels", url: "/dashboard/kennels", icon: Home },
        { title: "Network Transfers", url: "/dashboard/transfers", icon: ArrowRightLeft, notificationKey: "pendingTransfers" },
        { title: "Medical Pipeline", url: "/dashboard/medical-pipeline", icon: Stethoscope, notificationKey: "medicalTasks", usesGoogleDrive: true, proOnly: true },
        { title: "Adoption Applications", url: "/dashboard/applications", icon: FileText, notificationKey: "applications", proOnly: true },
        { title: "Intake Manager", url: "/dashboard/intake", icon: Inbox, proOnly: true },
      ],
      defaultOpen: true,
    },
    {
      ...
      items: [
        ...
        { title: "Foster Management", url: "/dashboard/foster-management", icon: PawPrint, notificationKey: "fosterUpdates", usesGoogleDrive: true, proOnly: true },
        { title: "Foster Pipeline", url: "/dashboard/foster-pipeline", icon: Kanban, proOnly: true },
        { title: "Volunteer Management", url: "/dashboard/volunteers", icon: UserCircle, proOnly: true },
        { title: "Volunteer Pipeline", url: "/dashboard/volunteer-pipeline", icon: Kanban, proOnly: true },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Newsletter Designer", url: "/dashboard/newsletter-designer", icon: Palette, proOnly: true },
      ],
      defaultOpen: false,
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Grants", url: "/dashboard/grants", icon: Briefcase, proOnly: true },
        ...
        { title: "Contract Templates", url: "/dashboard/contract-templates", icon: FileSignature, usesGoogleDrive: true, proOnly: true },
        { title: "Custom Forms", url: "/dashboard/custom-forms", icon: FileSignature, proOnly: true },
        { title: "Form Testing", url: "/dashboard/form-testing", icon: FileSignature, proOnly: true },
        { title: "Site Permissions", url: "/dashboard/site-permissions", icon: Shield, proOnly: true },
        { title: "Compliance & Watchdog", url: "/dashboard/compliance", icon: Shield, proOnly: true },
        ...
        { title: "Adopter Portal Preview", url: "/dashboard/adopter-portal-preview", icon: Eye, proOnly: true },
  ...
  // Filter groups and items based on permissions and tier
  const filteredGroups = navigationGroups
    .map(group => ({
      ...group,
      items: group.items.filter(item => {
        if (isLiteTier && item.proOnly) return false;
        return shouldShowMenuItem(item.url);
      })
    }))
    ...
    <Sidebar>
      ...
      <SidebarFooter className="border-t p-4">
        ...
        <div className="mt-3 pt-3 border-t border-border/50 space-y-2">
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton asChild isActive={location === "/dashboard/my-account"}>
                <Link href="/dashboard/my-account" data-testid="link-sidebar-my-account">
