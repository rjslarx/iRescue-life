...
`;
      ...
      for (const p of prescriptions) {
        ...
        const endDate = p.endDate ? new Date(p.endDate).toLocaleDateString() : 'Ongoing';
        content += `- ${p.medicationName} | ${p.dosage} | ${p.frequency} | Started: ${startDate} | Until: ${endDate}\n`;
      }
      ...
      for (const proc of procedures) {
        ...
        content += `- ${proc.procedureName} | Date: ${date} | Vet: ${proc.veterinarian || 'Not recorded'}\n`;
      }
