...
export const tenants = pgTable("tenants", {
  ...
  formNotificationsEnabled: boolean("form_notifications_enabled").notNull().default(true), // Whether to send email notifications for form submissions
  ...
  heroFocalPoint: text("hero_focal_point").default("center"), // Focal point for hero image on mobile (center, top, bottom, left, right, top-left, top-right, bottom-left, bottom-right)
...
export const animals = pgTable("animals", {
  ...
  // Subscription limits: Only "active" statuses (available, pending, foster, medical_hold, stray_hold, bite_hold, pending_transport, transfer) count toward
  ...
  status: text("status").notNull().default("available").$type<"available" | "pending" | "adopted" | "foster" | "medical_hold" | "stray_hold" | "bite_hold" | "deceased" | "pending_transport" | "transferred_out" | "transfer">(),
...
export const transportManifestItems = pgTable("transport_manifest_items", {
  ...
  previousAnimalStatus: text("previous_animal_status").$type<"available" | "pending" | "adopted" | "foster" | "medical_hold" | "stray_hold" | "bite_hold" | "deceased" | "pending_transport" | "transferred_out" | "transfer">(),
  // Timestamps
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at").notNull().defaultNow(),
});
