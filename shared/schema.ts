...
export const animals = pgTable("animals", {
  ...
  // Subscription limits: Only "active" statuses (available, pending, foster, medical_hold, stray_hold, bite_hold, pending_transport) count toward
  ...
  status: text("status").notNull().default("available").$type<"available" | "pending" | "adopted" | "foster" | "medical_hold" | "stray_hold" | "bite_hold" | "deceased" | "pending_transport" | "transferred_out">(),
...
export const transportManifestItems = pgTable("transport_manifest_items", {
  ...
  previousAnimalStatus: text("previous_animal_status").$type<"available" | "pending" | "adopted" | "foster" | "medical_hold" | "stray_hold" | "bite_hold" | "deceased" | "pending_transport" | "transferred_out">(),
  // Timestamps
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at").notNull().defaultNow(),
});
